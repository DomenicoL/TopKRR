...
### 2.3 Asymptotic Derivation $\rightarrow \mathcal{O}(N \log D)$
...
## 3. Average-Case Scenario Analysis (The Solver Reality)
...
### 3.3 Asymptotic Derivation $\rightarrow \mathcal{O}(N)$
